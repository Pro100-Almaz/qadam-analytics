...
def generate_strengths_prompt(student_data: dict, basic_info: str, language: str) -> tuple[str, str]:
    ...
    system_description = sys_descriptions['strengths'][language]
    ...
    user_prompt = f"""
        {user_descriptions['strengths'][language]}
