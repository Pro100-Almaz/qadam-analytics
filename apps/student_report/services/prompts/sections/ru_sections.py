ru_section_prompts = {
    ...
    Сгенерируйте ТОЛЬКО следующую JSON-структуру:
    {
        "subject_analyses": {
             "SubjectName": {
               "analysis": "5-6 предложения об успеваемости по этому предмету (БЕЗ оценок, БЕЗ процентов)",
               "recommendation": "Конкретная практическая рекомендация по этому предмету, нужно учитывать комментарий учителя если есть"
             }
           }
    }
    """,
