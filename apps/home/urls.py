...
from apps.home.api.students import api_upload_student_avatar
...
urlpatterns = [
    ...
    path('students/<int:pk>/upload_student_avatar/', api_upload_student_avatar, name='upload_student_avatar'),
