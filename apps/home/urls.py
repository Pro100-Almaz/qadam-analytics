...
urlpatterns = [
    ...
    path('students/<int:pk>/update', student_profile_update, name='student_profile_update'),
    ...
    path('teachers/<int:pk>/update', teacher_profile_update, name='teacher_profile_update'),
